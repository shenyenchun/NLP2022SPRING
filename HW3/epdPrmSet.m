...
epdPrm.fixedSegmentCount=[];	% Set this to a number of required segments if necessary
...
% For method='volhod'
epdPrm.vhRatio=0.02;	% 0.11
epdPrm.diffOrder=2;
epdPrm.volWeight=0.5;
epdPrm.vhMinMaxPercentile=3;		% 5.0%

epdPrm.fixedSegmentCount=[];
